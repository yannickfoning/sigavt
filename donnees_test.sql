...
INSERT INTO parametres (id, nom_agence, telephone, email, ville_principale, adresse, created_at, updated_at) 
...
VALUES 
(1, 'LT-234-AB', 'Toyota Coaster', 24, 1, 1, 'OPERATIONNEL', DATE_ADD(NOW(), INTERVAL 30 DAY), DATE_ADD(NOW(), INTERVAL 180 DAY), NOW(), NOW()),
(2, 'LT-567-CD', 'Hyundai County', 28, 1, 1, 'OPERATIONNEL', DATE_ADD(NOW(), INTERVAL 45 DAY), DATE_ADD(NOW(), INTERVAL 200 DAY), NOW(), NOW()),
(3, 'LT-890-EF', 'Toyota Coaster', 24, 2, 1, 'OPERATIONNEL', DATE_ADD(NOW(), INTERVAL 60 DAY), DATE_ADD(NOW(), INTERVAL 150 DAY), NOW(), NOW()),
(4, 'LT-123-GH', 'Mercedes-Benz Sprinter', 18, 3, 2, 'MAINTENANCE', DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_ADD(NOW(), INTERVAL 90 DAY), NOW(), NOW()),
(5, 'LT-456-IJ', 'Toyota Coaster', 24, 4, 2, 'OPERATIONNEL', DATE_ADD(NOW(), INTERVAL 20 DAY), DATE_ADD(NOW(), INTERVAL 170 DAY), NOW(), NOW()),
(6, 'LT-789-KL', 'Hyundai County', 28, 5, 3, 'OPERATIONNEL', DATE_ADD(NOW(), INTERVAL 50 DAY), DATE_ADD(NOW(), INTERVAL 190 DAY), NOW(), NOW()),
(7, 'LT-012-MN', 'Toyota Coaster', 24, 6, 3, 'HORS_SERVICE', DATE_SUB(NOW(), INTERVAL 30 DAY), DATE_SUB(NOW(), INTERVAL 10 DAY), NOW(), NOW()),
(8, 'LT-345-OP', 'Mercedes-Benz Sprinter', 18, 7, 1, 'OPERATIONNEL', DATE_ADD(NOW(), INTERVAL 25 DAY), DATE_ADD(NOW(), INTERVAL 160 DAY), NOW(), NOW());
...
-- 6. Utilisateurs (avec mots de passe hashés - admin123)
INSERT INTO utilisateurs (id, nom_complet, email, mot_de_passe, role, telephone, created_at, updated_at) 
VALUES 
(1, 'Administrateur SIGAVT', 'admin@sigavt.cm', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EH', 'ADMIN', '+237 699 000 000', NOW(), NOW()),
(2, 'Gérant Yaoundé', 'gerant.yaounde@sigavt.cm', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EH', 'GERANT', '+237 699 111 000', NOW(), NOW()),
(3, 'Agent Billetterie', 'billetterie@sigavt.cm', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EH', 'BILLETTERIE', '+237 677 222 000', NOW(), NOW()),
(4, 'Comptable', 'comptable@sigavt.cm', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt6Z5EH', 'COMPTABLE', '+237 699 333 000', NOW(), NOW());

-- 7. Voyages (pour les 7 prochains jours)
...
VALUES 
-- Aujourd'hui
(1, 1, 1, 1, CURDATE(), '06:00:00', 'PLANIFIE', 24, NOW(), NOW()),
(2, 1, 2, 2, CURDATE(), '08:00:00', 'PLANIFIE', 28, NOW(), NOW()),
(3, 2, 3, 1, CURDATE(), '07:00:00', 'PLANIFIE', 24, NOW(), NOW()),
-- Demain
(4, 1, 1, 1, DATE_ADD(CURDATE(), INTERVAL 1 DAY), '06:00:00', 'PLANIFIE', 24, NOW(), NOW()),
(5, 3, 5, 5, DATE_ADD(CURDATE(), INTERVAL 1 DAY), '05:30:00', 'PLANIFIE', 18, NOW(), NOW()),
(6, 4, 5, 5, DATE_ADD(CURDATE(), INTERVAL 1 DAY), '07:30:00', 'PLANIFIE', 18, NOW(), NOW()),
-- Dans 2 jours
(7, 1, 2, 2, DATE_ADD(CURDATE(), INTERVAL 2 DAY), '08:00:00', 'PLANIFIE', 28, NOW(), NOW()),
(8, 5, 6, 2, DATE_ADD(CURDATE(), INTERVAL 2 DAY), '09:00:00', 'PLANIFIE', 28, NOW(), NOW()),
-- Dans 3 jours
(9, 6, 8, 1, DATE_ADD(CURDATE(), INTERVAL 3 DAY), '07:00:00', 'PLANIFIE', 24, NOW(), NOW()),
(10, 7, 8, 1, DATE_ADD(CURDATE(), INTERVAL 3 DAY), '08:30:00', 'PLANIFIE', 24, NOW(), NOW()),
-- Dans 4 jours
(11, 1, 1, 1, DATE_ADD(CURDATE(), INTERVAL 4 DAY), '06:00:00', 'PLANIFIE', 24, NOW(), NOW()),
(12, 2, 3, 1, DATE_ADD(CURDATE(), INTERVAL 4 DAY), '07:00:00', 'PLANIFIE', 24, NOW(), NOW()),
-- Dans 5 jours
(13, 3, 5, 5, DATE_ADD(CURDATE(), INTERVAL 5 DAY), '05:30:00', 'PLANIFIE', 18, NOW(), NOW()),
(14, 4, 5, 5, DATE_ADD(CURDATE(), INTERVAL 5 DAY), '07:30:00', 'PLANIFIE', 18, NOW(), NOW()),
-- Dans 6 jours
(15, 8, 6, 2, DATE_ADD(CURDATE(), INTERVAL 6 DAY), '04:00:00', 'PLANIFIE', 28, NOW(), NOW());

-- 8. Billets (ventes récentes)
...
(5, 'BIL-2026-00005', 1, 'Atangana Pierre', '+237 677 999 000', 'A3', 'PLEIN_TARIF', 8000, 'ANNULE', DATE_SUB(NOW(), INTERVAL 1 DAY), 'ESPECES', NOW(), NOW());

-- 9. Colis
INSERT INTO colis (id, numero_tracking, expediteur, telephone_expediteur, destinataire, telephone_destinataire, ville_depart, ville_arrivee, poids_kg, type_colis, description, fragile, urgent, assure, prix, statut, date_enregistrement, mode_paiement, created_at, updated_at VALUES 
...
(2, 'COL-2026-TRK002', 'Ahmadou Tidjani', '+237 699 333 555', 'Aisha Moussa', '+237 677 444 666', 'Douala', 'Bafoussam', 2.3, 'DOCUMENT', 'Dossiers administratifs', true, true, false, 8000, 'LIVRE', DATE_SUB(NOW(), INTERVAL 1 DAY), 'ORANGE_MONEY', NOW(), NOW()),
...
(5, 'COL-2026-TRK005', 'Jean Pierre', '+237 677 999 111', 'Sophie Anne', '+237 699 000 222', 'Yaoundé', 'Ebolowa', 3.2, 'MARCHANDISE', 'Livres scolaires', false, true, false, 9000, 'RECLAME', DATE_SUB(NOW(), INTERVAL 2 DAY), 'ESPECES', NOW(), NOW());
...
VALUES 
(1, 'ENTRANT', 'Demande de partenariat', 'Ministère des Transports', 'Direction SIGAVT', 'Suite à notre réunion du 15 juillet, nous souhaitons formaliser notre partenariat pour le transport des fonctionnaires.', 'TRAITE', 'NORMALE', DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY), NOW(), NOW()),
(2, 'SORTANT', 'Facture mensuelle', 'Service Comptabilité', 'Entreprise Fuel CM', 'Facture N°2026-07-001 pour le carburant du mois de juillet.', 'ENVOYE', 'NORMALE', DATE_SUB(NOW(), INTERVAL 2 DAY), NULL, NOW(), NOW()),
(3, 'ENTRANT', 'Réclamation client', 'M. Kamga Paul', 'Service Client', 'Je souhaite signaler un retard de 2h sur le voyage Yaoundé-Douala du 20 juillet.', 'NON_LU', 'URGENTE', DATE_SUB(NOW(), INTERVAL 1 DAY), NULL, NOW(), NOW()),
...
-- 11. Bulletins de paie (juillet 2026)
...
(6, '2026-07', 150000, 15000, 4000, 7000, 0, 2500, 6300, 16800, 5500, 0, 164200, 'PAYE', '2026-07-25', 'VIREMENT', NOW(), NOW()),
(7, '2026-07', 200000, 15000, 8000, 15000, 0, 2500, 8400, 22400, 12000, 0, 221600, 'PAYE', '2026-07-25', 'VIREMENT', NOW(), NOW()),
(8, '2026-07', 125000, 15000, 3500, 6000, 0, 2500, 5250, 14000, 3800, 0, 137450, 'PAYE', '2026-07-25', 'ESPECES', NOW(), NOW());
...
(1, CURDATE(), 'RECETTE', 'BILLETTERIE', 'Vente billet BIL-2026-00001', 8000, 'BIL-2026-00001', NOW(), NOW()),
(2, CURDATE(), 'RECETTE', 'BILLETTERIE', 'Vente billet BIL-2026-00002', 8000, 'BIL-2026-00002', NOW(), NOW()),
(3, CURDATE(), 'RECETTE', 'BILLETTERIE', 'Vente billet BIL-2026-00003', 4000, 'BIL-2026-00003', NOW(), NOW()),
(4, CURDATE(), 'RECETTE', 'BILLETTERIE', 'Vente billet BIL-2026-00004', 6000, 'BIL-2026-00004', NOW(), NOW()),
-- Recettes colis
(5, CURDATE(), 'RECETTE', 'COLIS', 'Enregistrement colis COL-2026-TRK001', 11000, 'COL-2026-TRK001', NOW(), NOW()),
(6, DATE_SUB(NOW(), INTERVAL 1 DAY), 'RECETTE', 'COLIS', 'Enregistrement colis COL-2026-TRK002', 8000, 'COL-2026-TRK002', NOW(), NOW()),
(7, CURDATE(), 'RECETTE', 'COLIS', 'Enregistrement colis COL-2026-TRK003', 35000, 'COL-2026-TRK003', NOW(), NOW()),
(8, CURDATE(), 'RECETTE', 'COLIS', 'Enregistrement colis COL-2026-TRK004', 5000, 'COL-2026-TRK004', NOW(), NOW()),
-- Dépenses salaires
...
(13, DATE_SUB(NOW(), INTERVAL 3 DAY), 'DEPENSE', 'CARBURANT', 'Carburant bus LT-234-AB', 150000, 'CARB-2026-07-001', NOW(), NOW()),
(14, DATE_SUB(NOW(), INTERVAL 3 DAY), 'DEPENSE', 'CARBURANT', 'Carburant bus LT-567-CD', 145000, 'CARB-2026-07-002', NOW(), NOW()),
-- Dépenses maintenance
(15, DATE_SUB(NOW(), INTERVAL 7 DAY), 'DEPENSE', 'MAINTENANCE', 'Maintenance bus LT-123-GH', 85000, 'MAINT-2026-07-001', NOW(), NOW()),
-- Dépenses assurance
(16, DATE_SUB(NOW(), INTERVAL 15 DAY), 'DEPENSE', 'ASSURANCE', 'Assurance flotte mensuelle', 250000, 'ASSUR-2026-07-001', NOW(), NOW());
